...
<p class="descr">Conferences are events where a certain number of speakers come together to
    talk about certain technologies.</p>
<h2>Workshops</h2>
<img alt="The conference image is missing" src="img/work.jpg" height="245" width="375">
<p class="descr">Workshops are events where people can come together and do certain activities to gain
some skills.</p>
<h2>Hackathon</h2>
<img alt="The conference image is missing" src="img/hack.jpg" height="245" width="375">
<p class="descr">This event brings people together to do a week long sprint to develop
